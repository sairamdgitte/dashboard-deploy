            ...
            dbc.Card([
                ...
                dbc.CardBody([
                    ...
                    html.H2(id='content-positive', children='{}%'.format(
                        round(100 * (len(positive_tweets) / (len(positive_tweets) + len(negative_tweets))))),
            ...
            dbc.Card([
                ...
                dbc.CardBody([
                    ...
                    html.H2(id='content-negative', children='{}%'.format(
                        round(100 * (len(negative_tweets) / (len(positive_tweets) + len(negative_tweets))))),
                            style={'textAlign': 'center',
                                   'color': "black",
                                   'background-color': '#41B3A3'})
                ], style={'borderRadius': '0px 0px 25px 0px', 'overflow': 'hidden', 'background-color': '#41B3A3'})
            ...
            dbc.Card([
                ...
                dbc.CardBody([
                    ...
                    html.H2(id='content-tweets',
                            children='{}K'.format(round((len(positive_tweets) + len(negative_tweets)) / 1000, 1)),
                            style={'textAlign': 'center',
                                   'color': "black",
                                   'background-color': '#41B3A3'})
                ], style={'borderRadius': '0px 0px 25px 0px', 'overflow': 'hidden', 'background-color': '#41B3A3'})
